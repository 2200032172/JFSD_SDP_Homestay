...
import com.klef.jfsd.sdp.service.UserService;
	...
	public class HomestayController {
	    ...
	    @PostMapping("/deleteHomestay")
	    public String deleteHomestay(@RequestParam("id") Long id) {
	        homestayService.deleteHomestay(id);
	        return "redirect:/adminhome";
	    }

	    @PostMapping("/updateHomestay")
	    public String updateHomestay(
	        ...
	        homestayService.updateHomestay(id, name, description, price, place, imageFile);
	        return "redirect:/adminhome";
	    }
